...
import br.com.cssis.webservice.service.FarmaciaConveniadaWs;

@Service(value = FarmaciaConveniadaWs.SERVICE_NAME)
@WebService(portName = "FarmaciaConveniadaPort", serviceName = "FarmaciaConveniadaService", endpointInterface = "br.com.cssis.webservice.service.FarmaciaConveniadaWs", targetNamespace = "webservice.cssis.com.br")
public class FarmaciaConveniadaWsImpl implements FarmaciaConveniadaWs {

	private static final Log LOG = LogFactory.getLog(FarmaciaConveniadaWsImpl.class);
	 ...
	 */
	@Override
	public AddressLocationResult buscaFarmaciaConveniadaCidadeEstadoBairro(String cidade, String uf, String bairro, String rede, Boolean vinteQuatroHoras) {
		...
		try {
			...
			params.put("USO_INTERNO", StringHelper.isEmpty(rede) ? "A" : rede);
	 ...
	 */
	@Override
	public AddressLocationResult buscaFarmaciaConveniadaProximaEndereco(String cidade, String uf, String bairro, String logradouro, String numero, Integer raio, String rede, Boolean vinteQuatroHoras) {
		...
		try {
			...
			addressLocationResult = buscaFarmaciaConveniadaProxima(point.getY(), point.getX(), raio, rede, vinteQuatroHoras);
	 ...
	 */
	@Override
	public AddressLocationResult buscaFarmaciaConveniadaProxima(Double latitude, Double longitude, Integer raio, String rede, Boolean vinteQuatroHoras) {
	 ...
	 */
	@Override
	public AddressLocationResult buscaFarmaciaConveniadaCep(String cep, String rede, Boolean vinteQuatroHoras) {
		...
		try {
			...
			while (SetHelper.isEmpty(addressLocationResult.getAddressLocations()) && raio <= 10) {
				...
				addressLocationResult = buscaFarmaciaConveniadaProxima(latitude, longitude, raio, rede, vinteQuatroHoras);
